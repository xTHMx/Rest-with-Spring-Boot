...
public class User implements UserDetails, Serializable {
    ...
    @ManyToMany(fetch = FetchType.EAGER) //EAGER indica que quando carregar o user, carrega permissions
    @JoinTable(name = "user_permission",       //mapeamento da tabela de junção
    ...
    /// Funções que precisam existir por convesão do UserDetails -> JPA (hibernate)
    ...
    /// Getter e Setters padrões nossos
